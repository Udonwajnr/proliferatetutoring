...
const Hero = () => {
  return (
    <div className=''>
        ...
        <div className='max-w-[800px] h-[400px] m-auto rounded-2xl relative bottom-20 z-30'>
            <div className='relative flex flex-col h-full justify-between'>
                <img src={code} alt="" className='absolute -z-10 top-0 w-full object-fit h-[400px] rounded-2xl'/>

                <div className='flex items-center justify-between mt-3 px-5'>
                    <span className='text-white font-bold text-md'>English Language Class</span>    
                        <div className='flex bg-white items-center gap-x-3 rounded-2xl px-2'>
                ...
                <div className='flex justify-between mb-3 px-5'>
                    <button className='bg-blue-bg rounded-xl text-white py-2 px-5 font-bold'>Join Class</button>
                    <div>
                        <span className='text-white font-bold'>15 student Joined</span>
                        <img src="" alt="" />
                    </div>
                </div>
            </div>            
